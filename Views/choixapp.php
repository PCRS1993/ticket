                ...
                <div class="col-6">
                    <div class="card border border-primary">
                        <div class="card-header bg-primary">
                            <div class= "text-center text-primary font-weight-bold">Choix de l'Apprenant</div>
                        </div>
                        <form>
                        <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label for="uname">Jour</label>
                                        <input type="text" class="form-control" id="uname" placeholder="entrer le jour" name="nom">
                                    </div>
                                    </div>
                                <div class="form-group">
                                    <label for="exampleFormControlSelect2">Choisi un menu</label>
                                    <select multiple class="form-control" id="exampleFormControlSelect2">
                                    <option>Yassa GUINAR</option>
                                    <option>MAFFÉ</option>
                                    <option>Thiébou DJEUNE</option>
                                    <option>Cous-Cous</option>
                                    <option>Dakhine</option>
                                    </select>
                                    </div>
                                    </form>
                                    <div class="form-row">
